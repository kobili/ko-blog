                    ...
                    <div className="mt-10">
                        ...
                        <div className="mb-10">
                            ...
                            <Paragraph>
                                ...
                                I have used CDK to write and deploy serverless API Gateway APIs with Lambda and Step Function integration, as well as the SAM CLI to test said APIs locally.
                        ...
                        <div>
                            ...
                            <Paragraph>
                                I am very familiar with the use of Git along with Github to manage projects and to collaborate with teammates.
                            </Paragraph>
                        </div>
                    </div>
...
const Header = ({ children }: ParentComponentProps) => {
    return (
        <>
...
const SubHeader = ({ children }: ParentComponentProps) => {
    return (
        <>
...
const Paragraph = ({ children }: ParentComponentProps) => {
    return (
        <>
            <p className="my-3">
                {children}
